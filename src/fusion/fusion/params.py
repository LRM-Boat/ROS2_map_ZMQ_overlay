...
sub_topic_pcd = '/synced/velodyne_points'

# Name of the topic the overlay node gets its image files from
sub_topic_image = '/synced/ximea_frames'
...
if sim_data == "yes":
    ...
    translation = (0.0, 0.0, 0.0) # according to TUM wiki
    rotation = (0,0,0) # The order the rotation is done is z,y',x''
# translation = (0.15276, 0.742, 0.58437)
# Default user input transformation / rotation --> don't change
usr_translation = (0,0,0) 
usr_rotation = (0,0,0)

### Front camera FOV / Simaltaion FOV
# or (33.39848846798724, 25.36076698363964)
horizontal_FOV_cam = 74.45484939190598 # Total FOV in degrees
vertical_FOV_cam = 55.326097522969334 # Total FOV in degrees
...
# Sensorsize = 1/1.8" --> 7.1*5.3mm
width_sensorsize = 0.0071 # 7,2mm
height_sensorsize = 0.0053 # 5,4mm
focal_length = 0.012 # 12mm

# Following parameters need to be defined in case of simulator data or camera usage
width_pixels = 1769 # horizontal number of pixels from camera image / simulation image
height_pixels = 1225 # vertical number of pixels from camera image / simulation image
...
if sim_data == "yes":
    ...
    mp = np.array([[1.16412825e+03, 0.00000000e+00, 1.03375078e+03],
                   [0.00000000e+00, 1.16847094e+03, 7.83117249e+02],
